...
echo "1. Upload your application files to /opt/speech-labeling/"
echo "   scp -r . ec2-user@\$(curl -s ifconfig.me):/opt/speech-labeling/"
echo ""
echo "2. Upload audio files to /opt/audio/"
echo "   scp -r audio-directory/* ec2-user@\$(curl -s ifconfig.me):/opt/audio/"
echo ""
echo "3. Upload CSV data file:"
echo "   scp err-dataset.csv ec2-user@\$(curl -s ifconfig.me):/opt/data/"
echo ""
